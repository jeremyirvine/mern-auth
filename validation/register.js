...
module.exports = function validateRegisterInput(data) {
    ...
    if (!Validator.isLength(data.password, { min: 6, max: 30 })) { errors.password2 = "Password must be 6-30 characters" }
    if (!Validator.equals(data.password, data.password2)) { errors.password2 = "Confirm Password should be the same as Password" }
